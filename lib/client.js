...
// 不支持相对路径 JSON —— `./i18n/*.json` 会抛 missed-the-module-table；字典内嵌为 JS 对象字面量（源文本保留在 lib/i18n/*.json）
L = {
  zh: {
...
// 字典内嵌于 createModule（2026-09-13 曾迁到 lib/i18n/*.json 用宿主 require 读，
// 但 DSH 浏览器端 require 不支持相对路径 JSON，已回退内嵌；源文本保留 lib/i18n/*.json 供维护）。
